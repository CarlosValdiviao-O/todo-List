...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n    border: 1px solid black;\n}\n\nbody {\n    position: relative;\n}\n\n.hide {\n    display: none;   \n}\n\n/*\norder projects based on duedate on home\ncreate today and this week tabs\nadd form validation\nadd confirm changes on enterkey pressed\n*/", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,SAAS;IACT,UAAU;IACV,sBAAsB;IACtB,uBAAuB;AAC3B;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,aAAa;AACjB;;AAEA;;;;;CAKC","sourcesContent":["* {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n    border: 1px solid black;\n}\n\nbody {\n    position: relative;\n}\n\n.hide {\n    display: none;   \n}\n\n/*\norder projects based on duedate on home\ncreate today and this week tabs\nadd form validation\nadd confirm changes on enterkey pressed\n*/"],"sourceRoot":""}]);
// Exports
...
function createTodo (todo, project) {
    ...
    let name = (0,_functions__WEBPACK_IMPORTED_MODULE_0__.addChildElement)(container, 'h4', '.name');
    ...
    let move = (0,_functions__WEBPACK_IMPORTED_MODULE_0__.addChildElement)(container, 'button', '.move');
    move.textContent = '->';
...
function createForm (project, type, picked, div) {
    let form;
    if (type == 'project') {
        form = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.addChildElement)(display, 'form');
    }
    else {
    ...
    if (type == 'project') {
        ...
        else date.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(picked.date), 'yyyy-MM-dd');
    ...
    let cancel = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.addChildElement)(form, 'button');
    cancel.textContent = 'Q';
    cancel.addEventListener('click', () => {
        if (type == 'project') {
            form.remove();
...
function createMoveOptions (todo, project, div) {
    if (document.querySelector('#move-form'))
    document.querySelector('#move-form').remove();
    let options = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.addChildElement)(div, 'select', '#move-form');
    let database = (0,___WEBPACK_IMPORTED_MODULE_2__.getDatabase)();
    let projects = database.projects;
    for (let i=0; i<projects.length; i++) {
        let option = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.addChildElement)(options, 'option');
        option.textContent = projects[i].name;
        option.value = i;
        if (i == projects.indexOf(project))
        option.selected = true;
    }
    options.addEventListener('change', () => (0,___WEBPACK_IMPORTED_MODULE_2__.moveTodo)(todo, project, div, options.value));
}
